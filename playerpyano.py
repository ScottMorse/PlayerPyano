import synthesizer
import ideas
from pymusician import Note,Chord,Mode
from random import randint

stream = synthesizer.Stream()

TEMPO = randint(50,150)
...
def run(tempo=TEMPO,key_quality=KEY_QUAL,key=KEY,harmonic_period=HARMONIC_RHYTHM):
    ...
    prev_note = None
    for chord in chords:
        melodic_ideas.append(ideas.produce_notes(chord,prev_note,HARMONIC_RHYTHM_VALUE,KEY))
